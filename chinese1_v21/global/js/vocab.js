$(document).ready(function () {
    ...
    function buildHTML(word) {
       ...
       var html = '<div class="vocab_img"><img src="' + word.image.source + '" alt="' + word.image.alt + '" class="' + word.image.class + '" data-width="' + word.image.width + '"data-copyright="' + word.image.copyright + '"data-caption="' + word.image.caption + '" /><span class="copyright">' + word.image.copyright + '</span></div>';
        ...
        if (word.nivel == 'uno') {
            html += '<div class="vocab_content"><div class="sptFrame pull-right" data-phrase="' + word.spt + '" data-showgauge='+word.showgauge+' data-showstt='+word.showstt+'></div><p class="vocab_word"><span lang="zh-Hans">' + wordvocab + '</span></p>' + wordUage(word.usage) + '';
        } else if (word.nivel == 'dos') {
            html += '<span class="vocab_phrase"><a href="//cdn.flvs.net/cdn/audio/index.htm" class="pop record_icon" data-height="240px"><img src="../../global/images/record.png" /></a>' + wordUage(word.usage) + '</span>';
        }

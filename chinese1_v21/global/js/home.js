...
function createMenus() {
    ...
    for (var i = 0; i < modules.length; i++) {
        ...
        // modTitle = 'Module ' + module.mID;
        modTitle = module.title+' ' + module.mID;
        ...
        for (var j = 0; j < module.lesson.length; j++) {
            ...
            // if (j == 0) popupmenu += '<div class="col-sm-3 modcase"><h3 class="moduleTitle">' + modTitle + '</h3><br><img class="yellowdart" src="global/images/home/yellowdart.png"></div><div class="col-sm-3">';
            let num = module.num ? Number(module.num) : 0

            // convert module number to roman numeral for later use
            var realNum = parseInt(num);
            if (j == 0) popupmenu += '<div class="col-sm-3 modcase"><div class="row"><div class="col-sm-7 text-right"><h3 class="moduleTitle"> Module <span class="mnumber">' + realNum + ' </span></h3><p class="unlock mname">' + module.title + ' ' + '</p></div><div class="col-sm-5"><img class="yellowdart" src="global/images/home/yellowdart.png"></div></div> </div><div class="col-sm-3">';
            //popupmenu += "<a href=\"".concat(link2, "\"><strong><span class=\"linkColor lesson_num\">").concat('0' + lesson.num, "</span></strong> <span class=\"lesson_name\">").concat('&ndash;&nbsp;&nbsp;' + lesson.title, "</span><br></a>");
            popupmenu += "<a href=\"".concat(link2, "\"><strong><span class=\"linkColor lesson_num\">").concat(lesson.num, "</span></strong> <span class=\"lesson_name\">").concat('&ndash;&nbsp;&nbsp;' + lesson.title, "</span><br></a>");
        ...
        //     moduleSubs.append($("<div class=\"moduleLink invisible\" id=\"module".concat(num, "\"/>")).html(_temp));
        // }
        if (num > 0 && num < 4) {
            // var normal = $('<span />').html('0' + num);
            var normal = $('<span />').html(num);
